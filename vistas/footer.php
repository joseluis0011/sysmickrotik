<!-- jQuery -->
    ...
    <script src="../public/build/js/animatescroll/animatescroll.js" type="text/javascript"></script>
    <!-- Bootstrap -->
 ...
 <!-- Datatables -->
    ...
    <script src="../public/vendors/jQuery-Smart-Wizard/js/jquery.smartWizard.js" type="text/javascript"></script>
    ...
    <!-- SweetAlert2 --> 
    <script src="../public/js/sweetalert2.js" type="text/javascript"></script>
    <!-- jquery.inputmask -->
    <script src="../public/vendors/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js" type="text/javascript"></script>
